...
const sections = [
  {
    ...
    items: [
      "When you use our Platform or avail the Services, we seek or collect information such as your name, mother's name, father's name, password, date of birth, gender, Permanent Account Number (PAN), signature, marital status, nominee details, cancelled cheque, photograph and video recording, email id, phone number, educational or professional qualification, business name, business address, nature of business, Goods and Services Tax Identification Number (GSTIN), Tax Deduction and Collection Account Number (TAN), bank account details, United Payments Interface (UPI) ID, and/or other payment and investment information and copies of KYC documents.",
      "In case you are required to provide your Aadhaar details to us during account creation, you acknowledge and agree that the act of providing your Aadhaar details to us is voluntary. We require Aadhaar details solely for the purpose of carrying out KYC and for filing of ITRs.",
      "We collect mobile numbers and e-mail addresses that you provide us on the Platform and use the same for sending various communications to you.",
      "When you visit our Platform or avail the Services, we collect certain information about your interaction with our Platform including the pages that you view, your internet protocol address, the links you select or actions you take, browser type, the unique identifier of your device and device information such as operating system, operating system version, browser plug-ins, crashes, system activity, hardware settings, location based information, date and time of your request and referral URL, and cookies.",
      "We may retrieve your information and records available with third party provider including credit score and liabilities information or information from the KYC Registration Agency, Goods and Services Tax Network (GSTN) and National Informatics Centre. You hereby authorise the Company to download and retrieve any information from governmental and other statutory bodies.",
      "When you avail the Services, we may, after obtaining consent, access and read information from your device, such as information from your SMS storage, for the provision of the Services. Further, certain Services require us to obtain access to the ability to make phone calls or send messages using your device.",
      "To prepare your income tax return, to file your e-return, to assist with your tax matters, and/or to provide an audit defence service, we collect information about your income, deductions, credits, dependents, etc. Collectively, this information is referred to as \"Tax Return Information\".",
    ],
  },
  {
    id: 2,
    ...
    items: [
      "To use your information to manage your account, to contact you, and to operate, improve, and deliver our Platform and Services.",
      "To use your information for maintaining a record of such information and your transactions securely and confidentially, and as required under the applicable laws.",
      "To use the services of third parties to provide the Platform and Services for you, who are bound to keep such information confidential.",
      "To troubleshoot software bugs and operational issues, to conduct data analysis, testing and research and to monitor and analyse usage and activity trends.",
      "To use the data in an aggregated/compiled form to produce statistical/demographic analyses for marketing, strategy and other business purposes.",
      ...
      "To summarise information about your usage and combine it with that of others to learn about the use of the Platform and Services.",
      "To retain copies of your completed and filed ITRs, including retrieving information from governmental and other statutory bodies.",
      "To use your information for market research, project planning, product development, troubleshoot problems, analyse user behaviour, marketing purposes, and promotions.",
      "To use your information to compute the charges for the products and services you purchase.",
      "To use the contact information to communicate with you. You expressly consent and authorise us to send you messages on your mobile number, call you on your mobile number, and communicate with you in any other manner.",
      "To prepare and file your IT return using your Tax Return Information, and provide related assistance and services.",
      "To use third-party advertising companies to display advertisements about goods and services of interest to you.",
      "To share your information with identified Strategic Partners, our third party service providers and our affiliates to host, use, copy, transmit, process, store, share, analyse, display, make derivations, and back up all data.",
      "To conduct an audit of your records without any notice in case of apprehension of fraud.",
      "To retain/store your data and confidential information in the Company's servers or cloud or otherwise in any other medium.",
    ],
    extras: [
      ...
      "You acknowledge, agree and authorise our partners and entities for who we act as a technology facilitator (including POWERFILING PRIVATE LIMITED) (\"Strategic Partners\") to collect, store, process, transfer your information including for the purpose of providing Services to you through the Platform.",
      "If you choose to use Services provided by our Strategic Partners or our third-party service providers through the Platform, your information may be governed by the terms of the privacy policy of such Strategic Partners and the third-party service providers.",
      "We may share/transfer/assign all of your information with any other business entities, including in the event of a merger, sale, reorganisation, amalgamation, joint ventures, assignment, restructuring of business or transfer or disposition of all or any portion of our business.",
    ],
  },
  {
    id: 3,
    title: "3. ERI Services for E-Filing",
    body: "ERI Services for filing your ITR are provided by POWERFILING PRIVATE LIMITED through our Platform. POWERFILING PRIVATE LIMITED is an authorised ERI as per the Electronic Furnishing of Return of Income Scheme, 2007. You authorise POWERFILING PRIVATE LIMITED to request and collect your personal and other information to provide e-filing services to you, add you as a client of the ERI, retrieve your income tax return information using ERI services, E-File access of your ITR, access, store and process your Form-16, perform other additional functions as necessary to discharge its responsibilities as ERI.",
  },
  {
    id: 4,
    title: "4. Cookie Policy",
    body: "Like many websites, we use cookies, flash cookies, web beacons or similar technologies. \"Cookies\" are small text files that are stored on your computer or other device when you visit certain online pages that record your preferences and actions. We use cookies for a variety of purposes, including remembering you and your preferences, tracking your use of our Platform, and facilitating your use of the Platform. Most web browsers automatically accept cookies, but, if you prefer, you can usually modify your browser settings to decline cookies. However, please note that refusing a cookie may limit your access and/or use of Platform and Services.",
  },
  {
    id: 5,
    title: "5. Identity Theft",
    items: [
      "There may be instances when you receive a seemingly legitimate-looking e-mail asking for your personal information such as your credit card details, bank account details, one-time passwords, contact information, etc. The Company will never ask for such information from you via e-mail.",
      "Such activities are usually carried on by unauthorised individuals and are illegal in nature. They are called phishing or identity theft. In case of any suspicion of such activity or on receiving such an e-mail, you are certain it was not sent by us. We advise you not to respond to such mail and to take whatever action you see fit.",
    ],
  },
  {
    id: 6,
    title: "6. Links to Other Sites",
    body: "Our Platform provides links to other websites and third-party platforms (\"Third-Party Platforms\"). Such Third-Party Platforms may collect information about you. We are not responsible for the privacy practices or the content of those linked websites and Third-Party Platforms. We recommend that you review the privacy policies of such Third-Party Platforms. In case you choose to log in through your Google account, we will access information from your Google account once they permit us to do so, whilst using the Google-related functionality of the Platform.",
  },
  {
    id: 7,
    title: "7. Data Retention by Us",
    items: [
      "We will retain your information only for as long as is necessary for the purposes set out in this Policy. We will retain and use your information to the extent necessary to comply with our legal obligations, resolve disputes, and enforce our legal agreements and policies.",
      "We encourage you to review the information and inform about any discrepancies, and any information found to be inaccurate shall be corrected or amended. Please reach out to us at contact@Powerfiling.com in case you would like to review the information collected by us.",
  ...
  },
  {
    ...
    body: "We work to protect your information from loss, misuse or unauthorised alteration by using industry-recognised security safeguards, coupled with carefully developed security procedures and practices. We maintain electronic and procedural safeguards of all information. We use both internal and external resources to review our security procedures.",
  },
  {
    id: 10,
    title: "10. Disclaimer",
    items: [
      "We make no representation as to providing or storing back-up copies of any information submitted to us. You shall be solely responsible for ensuring that you maintain back-up copies of such information.",
      "Although we take appropriate steps to maintain the security of information we collect from you, we assume no responsibility whatsoever to make good the losses and damages you may incur, due to privacy and/or security breach of your information.",
      "When payment information is being transmitted on or through the Platform, it will be protected by the encryption technology of third-party payment service providers, including payment gateways. The Company does not guarantee that the transmissions of your payment-related information or other information will always be secure.",
      "GSTN shall have the sole right and discretion, without any liability of any nature of the Company, to accept/reject any User's data from being transmitted to the GST system from our Platform.",
    ],
  },
  {
    id: 11,
